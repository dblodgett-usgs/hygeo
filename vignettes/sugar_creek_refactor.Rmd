...
split_sites <- nwis_sites %>%
  filter((100 * (REACH_meas - FromMeas) / (ToMeas - FromMeas)) > 25)
...
hyRefactor::refactor_nhdplus(nhd$flowline,
                             ...
                             events = split_sites,
                             exclude_cats = nwis_sites$COMID[!nwis_sites$COMID %in% split_sites$COMID])
...
nhd_crosswalk <- get_nhd_crosswalk(reconcile, waterbody_prefix) 
```
