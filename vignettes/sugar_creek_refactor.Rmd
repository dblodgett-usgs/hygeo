...
jsonlite::write_json(nhd_crosswalk, "crosswalk.json", 
                     pretty = TRUE)

write_sf(st_transform(catchment_data, 4326), "catchment_data.geojson")

write_sf(st_transform(waterbody_data, 4326), "waterbody_data.geojson")

write_sf(st_transform(nexus_data, 4326), "nexus_data.geojson")

write_sf(st_transform(nwis_sites, 4326), "nwis_sites.geojson")
```
